...
export class SchemeRoutingProvider {
  ...
  */
  ...
  constructor(private secretsProvider: SecretsProvider, private alertCtrl: AlertController, private translateService: TranslateService) {
  ...
  showTranslatedAlert(title: string, message: string, buttons: any[]): void {
